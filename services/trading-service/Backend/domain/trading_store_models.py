...
class MarketPriceTickRecord(Base):
    ...
    exchange_timezone: Mapped[str | None] = mapped_column(
        String(80),
        nullable=True,
    )
...
class PaperTradeRecord(Base):
    ...
    trailing_stop_loss: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
    )
    ...
    raw_safe_broker_response: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
    )
